...
import { ref, reactive, nextTick, unref, h } from 'vue'
import XEUtils from 'xe-utils'
import { VxeUI } from '../../../packages'
import { VxeGridProps, VxeColumnPropTypes, type SeqTooltipConfig, MouseScrollConfig } from '../../../types'
...
interface MyVxeGridProps extends VxeGridProps<RowVO> {
  seqTooltipConfig?: SeqTooltipConfig
  mouseScrollConfig?: MouseScrollConfig
}
const gridOptions = reactive<MyVxeGridProps>({
  border: true,
  loading: false,
  showFooter: true,
  showOverflow: true,
  ...
  seqTooltipConfig: {
    enabled: true,
    field: 'id',
    contentSlot: (params: any) => {
      return h('div', [
        h('div', '唯一uid'),
        h('div', unref(params.tooltip)?.reactData.tipContent)
      ])
    }
  },
  // mouseScrollConfig: {
